...
Usage:
    poetry run python pipeline/survey_repo_embedding.py /path/to/repo
    poetry run python pipeline/survey_repo_embedding.py /path/to/repo --backend gemini
    poetry run python pipeline/survey_repo_embedding.py /path/to/repo --languages Java
"""
