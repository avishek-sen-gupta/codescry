...
Identical to survey_classify_by_tfidf_logistic_regression.py up to the concretisation step, but instead of the
...
Usage:
    poetry run python pipeline/survey_classify_by_embedding_cosine_similarity.py /path/to/repo
    poetry run python pipeline/survey_classify_by_embedding_cosine_similarity.py /path/to/repo --backend gemini
    poetry run python pipeline/survey_classify_by_embedding_cosine_similarity.py /path/to/repo --languages Java
"""
